...
renders["north-biome"] = {
	...
	"dimension": "overworld",
	"overlay": ["combatupdate-overworld-day-north"],
	"northdirection": "upper-left",
	"renderchecks": "0",
	"markers": stw_markers,
}
...
renders["south-biome"] = {
	...
	"rendermode": [ClearBase(), BiomeOverlay()],
	"dimension": "overworld",
	"overlay": ["combatupdate-overworld-day-south"],
	"northdirection": "lower-right",
	"renderchecks": "0",
	"markers": stw_markers,
}
...
renders["east-biome"] = {
	...
	"rendermode": [ClearBase(), BiomeOverlay()],
	"dimension": "overworld",
	"overlay": ["combatupdate-overworld-day-east"],
	"northdirection": "upper-right",
	"renderchecks": "0",
	"markers": stw_markers,
}
...
renders["west-biome"] = {
	...
	"rendermode": [ClearBase(), BiomeOverlay()],
	"dimension": "overworld",
	"overlay": ["combatupdate-overworld-day-west"],
	"northdirection": "lower-left",
	"renderchecks": "0",
	"markers": stw_markers,
}
